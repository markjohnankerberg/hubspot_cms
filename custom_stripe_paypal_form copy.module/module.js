...
function renderProducts(products) {
    ...
    products.forEach((p, i) => {
      ...
      <div class="product_match_popup">
        <div class="match_icons">
          <img class="match_icon" src="${iconUrl}" alt="Matched gift" />
          <img class="match_icon" src="${iconUrl}" alt="Matched gift" />
          <img class="match_icon" src="${iconUrl}" alt="Matched gift" />
        </div>
    ...
    `;
        ...
        const updateMatchPopup = () => {
            ...
            if (qty > 0) {
                const iconCount = qty * 3;
                const iconsHTML = Array.from({ length: iconCount }, () =>
                    `<img class="match_icon" src="${iconUrl}" alt="Matched gift" />`
                ).join("");
                matchPopup.querySelector(".match_icons").innerHTML = iconsHTML;
            }
        };
