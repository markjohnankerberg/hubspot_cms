    ...
    if (data.skus) {
      ...
      if (skuBreakdownEl) {
        var SKU_ICON_MAP = {
          ...
          'FR16-1000': 'https://dl.dropboxusercontent.com/scl/fi/iy70krlvvvk0zhwej9kxu/Proclaimer-Bundle-600x600.png?rlkey=jk21ce4507g7mwm347jw2cb02&raw=1',
          ...
          'FR161000':  'https://dl.dropboxusercontent.com/scl/fi/iy70krlvvvk0zhwej9kxu/Proclaimer-Bundle-600x600.png?rlkey=jk21ce4507g7mwm347jw2cb02&raw=1'
        };
        var SKU_NAME_MAP = {
          'FR16-30':   'SD Card',
        ...
        skuBreakdownEl.innerHTML = sortedSkus.map(function (sku) {
          ...
          var name = SKU_NAME_MAP[baseKey] || baseKey;
          var icon = iconUrl ? '<img class="announcement-bar__sku-icon" src="' + iconUrl + '" alt="' + name + '" />' : '';
          var count = data.skus[sku] != null ? data.skus[sku].toLocaleString() : '—';
          return '<span class="announcement-bar__stat announcement-bar__skus">' + icon + '<span class="announcement-bar__sku-label"><strong>' + count + '</strong><span class="announcement-bar__sku-name">' + name + '</span></span></span>';
        }).join('');
      }
    }
  }
