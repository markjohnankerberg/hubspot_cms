...
function renderProducts(products) {
    ...
    products.forEach((p, i) => {
        ...
        if (p.sku === "FR16-500" || p.sku === "FR16-1000") {
            isHidden = "";
        }
      ...
      <label class="product_left">
        ...
        <span style="${isHidden}" class="matched_gift">MATCHED GIFT</span>
      </label>
    ...
    `;
        ...
        const updateMatchPopup = () => {
            ...
            if (qty > 0) {
                matchPopup.querySelector(".match_formula_text").textContent = `X 2 = ${qty * 3}`;
                matchPopup.querySelector(".match_label").textContent = `${qty * 3} ${displayName} will be delivered`;
            }
        };
